...
let recado = document.getElementById('recado_descricao');
let descricao = document.getElementById('recado_detalhamento');
let botaoSalvar = document.getElementById('botao_salvar');
let botaoSair = document.getElementById('botao_sair');
botaoSair.addEventListener('click', () => {
    const usuarios = JSON.parse(localStorage.getItem('bancoDados') || '[]');
